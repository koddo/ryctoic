...
create table cards (
        ...
        front              text not null    constraint card_front_length check ( 0 < char_length(front)  and  char_length(front) <= 5000 ),
        back               text not null    constraint card_back_length  check ( 0 < char_length(back)   and  char_length(back)  <= 5000 ),
