...
if(!((function (){var G__24783 = app_db;
if(G__24783){
...
return G__24783.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__24783.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__24783);
} else {
return false;
}
}
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__24789){
...
return cljs.core.get_in.call(null,new_db,p1__24790_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__24791_SHARP_){
return cljs.core.get_in.call(null,db,p1__24791_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__24792__i = 0, G__24792__a = new Array(arguments.length -  2);
while (G__24792__i < G__24792__a.length) {G__24792__a[G__24792__i] = arguments[G__24792__i + 2]; ++G__24792__i;}
  in_paths = new cljs.core.IndexedSeq(G__24792__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__24793){
var f = cljs.core.first(arglist__24793);
arglist__24793 = cljs.core.next(arglist__24793);
var out_path = cljs.core.first(arglist__24793);
var in_paths = cljs.core.rest(arglist__24793);
...
//# sourceMappingURL=middleware.js.map?rel=1434650168698