...
var f = (function (){var pred__25174 = cljs.core._EQ_;
var expr__25175 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25174.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25175))){
return ((function (pred__25174,expr__25175){
return (function (p1__25167_SHARP_){
return console.warn(p1__25167_SHARP_);
});
;})(pred__25174,expr__25175))
} else {
if(cljs.core.truth_(pred__25174.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25175))){
return ((function (pred__25174,expr__25175){
return (function (p1__25168_SHARP_){
return console.debug(p1__25168_SHARP_);
});
;})(pred__25174,expr__25175))
} else {
if(cljs.core.truth_(pred__25174.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25175))){
return ((function (pred__25174,expr__25175){
return (function (p1__25169_SHARP_){
return console.error(p1__25169_SHARP_);
});
;})(pred__25174,expr__25175))
} else {
return ((function (pred__25174,expr__25175){
return (function (p1__25170_SHARP_){
return console.log(p1__25170_SHARP_);
});
;})(pred__25174,expr__25175))
}
}
...
//# sourceMappingURL=utils.js.map?rel=1434650234734