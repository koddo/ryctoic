(defproject ryctoic "0.0.1"
  ...
  :cljsbuild {
              :builds [{:id "dev"
                        ...
                        :compiler {
                                   ;; :output-to "resources/public/static/js/compiled/ryctoic.js"
                                   :output-to "../www/static/js/compiled/ryctoic.js"

                                   ;; :output-dir "resources/public/static/js/compiled/out"
                                   :output-dir "../www/static/js/compiled/out"
                       ...
                       {:id "min"
                        ...
                        :compiler {
                                   ...
                                   :output-to "../www/static/js/compiled/ryctoic-min.js"
                                   :main ryctoic.core
  ...
  :figwheel {
             :http-server-root "symlink-to-www" ;; default and assumes "resources" 
             ;; :server-port 3449 ;; default

             ;; :css-dirs ["resources/public/css"]
             :css-dirs ["../www/static/js/css"]
