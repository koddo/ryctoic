...
return cljs.core.reduce.call(null,(function (result,p__24798){
var vec__24799 = p__24798;
var k = cljs.core.nth.call(null,vec__24799,(0),null);
var v = cljs.core.nth.call(null,vec__24799,(1),null);
...
var vec__24801 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24801,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24801,(1),null);
var ab = cljs.core.nth.call(null,vec__24801,(2),null);
...
var clojure$data$diff_associative = null;
var clojure$data$diff_associative__2 = (function (a,b){
...
var clojure$data$diff_associative__3 = (function (a,b,ks){
...
clojure$data$diff_associative = function(a,b,ks){
switch(arguments.length){
case 2:
return clojure$data$diff_associative__2.call(this,a,b);
case 3:
return clojure$data$diff_associative__3.call(this,a,b,ks);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
clojure$data$diff_associative.cljs$core$IFn$_invoke$arity$2 = clojure$data$diff_associative__2;
clojure$data$diff_associative.cljs$core$IFn$_invoke$arity$3 = clojure$data$diff_associative__3;
return clojure$data$diff_associative;
})()
;
clojure.data.diff_sequential = (function clojure$data$diff_sequential(a,b){
return cljs.core.vec.call(null,cljs.core.map.call(null,clojure.data.vectorize,clojure.data.diff_associative.call(null,((cljs.core.vector_QMARK_.call(null,a))?a:cljs.core.vec.call(null,a)),((cljs.core.vector_QMARK_.call(null,b))?b:cljs.core.vec.call(null,b)),cljs.core.range.call(null,(function (){var x__18099__auto__ = cljs.core.count.call(null,a);
var y__18100__auto__ = cljs.core.count.call(null,b);
return ((x__18099__auto__ > y__18100__auto__) ? x__18099__auto__ : y__18100__auto__);
})()))));
});
 ...
 */
clojure.data.EqualityPartition = (function (){var obj24803 = {};
return obj24803;
})();
...
if((function (){var and__17775__auto__ = x;
...
var x__18423__auto__ = (((x == null))?null:x);
return (function (){var or__17787__auto__ = (clojure.data.equality_partition[goog.typeOf(x__18423__auto__)]);
if(or__17787__auto__){
return or__17787__auto__;
} else {
var or__17787__auto____$1 = (clojure.data.equality_partition["_"]);
 ...
 * Implementation detail. Subject to change.
 */
clojure.data.Diff = (function (){var obj24805 = {};
return obj24805;
})();
...
if((function (){var and__17775__auto__ = a;
if(and__17775__auto__){
...
var x__18423__auto__ = (((a == null))?null:a);
return (function (){var or__17787__auto__ = (clojure.data.diff_similar[goog.typeOf(x__18423__auto__)]);
if(or__17787__auto__){
return or__17787__auto__;
} else {
var or__17787__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__17787__auto____$1){
return or__17787__auto____$1;
} else {
...
if((function (){var G__24806 = x;
if(G__24806){
var bit__18461__auto__ = (G__24806.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__18461__auto__) || (G__24806.cljs$core$IMap$)){
return true;
} else {
if((!G__24806.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__24806);
} else {
return false;
}
}
...
if((function (){var G__24807 = x;
if(G__24807){
var bit__18461__auto__ = (G__24807.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__18461__auto__) || (G__24807.cljs$core$ISet$)){
return true;
} else {
if((!G__24807.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__24807);
} else {
return false;
}
}
...
if((function (){var G__24808 = x;
if(G__24808){
var bit__18461__auto__ = (G__24808.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__18461__auto__) || (G__24808.cljs$core$ISequential$)){
return true;
} else {
if((!G__24808.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__24808);
} else {
return false;
}
}
...
return (function (){var G__24809 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__24809) {
case "map":
return clojure.data.diff_associative;
...
//# sourceMappingURL=data.js.map?rel=1434650168861