...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__18366__auto__,writer__18367__auto__,opt__18368__auto__){
return cljs.core._write.call(null,writer__18367__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__24599 = o;
(G__24599[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__24601__i < G__24601__a.length) {G__24601__a[G__24601__i] = arguments[G__24601__i + 0]; ++G__24601__i;}
  args = new cljs.core.IndexedSeq(G__24601__a,0);
} 
...
var old_24603 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_24603))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_24603)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__17775__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__24606 = jsprops;
(G__24606["defaultValue"] = value);

(G__24606["onChange"] = ((function (G__24606,v,value,on_change){
return (function (p1__24604_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24604_SHARP_);
});})(G__24606,v,value,on_change))
);
...
var vec__24608 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24608,(0),null);
var id = cljs.core.nth.call(null,vec__24608,(1),null);
var class$ = cljs.core.nth.call(null,vec__24608,(2),null);
...
var temp__4128__auto__ = (function (){var G__24610 = cljs.core.meta.call(null,v);
var G__24610__$1 = (((G__24610 == null))?null:reagent.impl.template.get_key.call(null,G__24610));
return G__24610__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__24612_24613 = v;
var G__24612_24614__$1 = (((G__24612_24613 == null))?null:reagent.impl.template.key_from_vec.call(null,G__24612_24613));
var G__24612_24615__$2 = (((G__24612_24614__$1 == null))?null:(jsprops["key"] = G__24612_24614__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__24618 = cljs.core.meta.call(null,argv);
var G__24618__$1 = (((G__24618 == null))?null:reagent.impl.template.get_key.call(null,G__24618));
return G__24618__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__24619 = (((jsprops == null))?{}:jsprops);
(G__24619["key"] = key);
...
var n__18672__auto___24620 = a.length;
var i_24621 = (0);
while(true){
if((i_24621 < n__18672__auto___24620)){
(a[i_24621] = reagent.impl.template.as_element.call(null,(a[i_24621])));
...
var a = cljs.core.into_array.call(null,s);
var n__18672__auto___24623 = a.length;
var i_24624 = (0);
while(true){
if((i_24624 < n__18672__auto___24623)){
var val_24625 = (a[i_24624]);
if((cljs.core.vector_QMARK_.call(null,val_24625)) && ((reagent.impl.template.key_from_vec.call(null,val_24625) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24624] = reagent.impl.template.as_element.call(null,val_24625));

var G__24626 = (i_24624 + (1));
i_24624 = G__24626;
continue;
} else {
}
...
var G__24628 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24628) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24628){
...
//# sourceMappingURL=template.js.map?rel=1435073923350