...
var or__17787__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__17787__auto__)){
return or__17787__auto__;
} else {
var or__17787__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__17787__auto____$1)){
return or__17787__auto____$1;
} else {
var or__17787__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__17787__auto____$2)){
return or__17787__auto____$2;
} else {
var or__17787__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__17787__auto____$3)){
return or__17787__auto____$3;
} else {
...
var n__18672__auto__ = a.length;
var i = (0);
while(true){
if((i < n__18672__auto__)){
var c_24567 = (a[i]);
if(cljs.core.truth_((c_24567["cljsIsDirty"]))){
(c_24567["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__18366__auto__,writer__18367__auto__,opt__18368__auto__){
return cljs.core._write.call(null,writer__18367__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__24571 = c;
var G__24571__$1 = (((G__24571 == null))?null:(G__24571["props"]));
var G__24571__$2 = (((G__24571__$1 == null))?null:(G__24571__$1["argv"]));
return G__24571__$2;
});
...
var G__24573_24574 = (c["cljsRatom"]);
var G__24573_24575__$1 = (((G__24573_24574 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__24573_24574));

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1435073922853