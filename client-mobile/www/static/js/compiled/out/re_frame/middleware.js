...
if(!((function (){var G__24782 = app_db;
if(G__24782){
...
return G__24782.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__24782.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__24782);
} else {
return false;
}
}
...
while (G__24787__i < G__24787__a.length) {G__24787__a[G__24787__i] = arguments[G__24787__i + 0]; ++G__24787__i;}
  args = new cljs.core.IndexedSeq(G__24787__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__24788){
...
return cljs.core.get_in.call(null,new_db,p1__24789_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__24790_SHARP_){
return cljs.core.get_in.call(null,db,p1__24790_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__24791__i = 0, G__24791__a = new Array(arguments.length -  2);
while (G__24791__i < G__24791__a.length) {G__24791__a[G__24791__i] = arguments[G__24791__i + 2]; ++G__24791__i;}
  in_paths = new cljs.core.IndexedSeq(G__24791__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__24792){
var f = cljs.core.first(arglist__24792);
arglist__24792 = cljs.core.next(arglist__24792);
var out_path = cljs.core.first(arglist__24792);
var in_paths = cljs.core.rest(arglist__24792);
...
//# sourceMappingURL=middleware.js.map?rel=1435073924764