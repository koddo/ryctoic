...
return cljs.core.reduce.call(null,(function (result,p__24797){
...
var vec__24800 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24800,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24800,(1),null);
var ab = cljs.core.nth.call(null,vec__24800,(2),null);
 ...
 */
clojure.data.EqualityPartition = (function (){var obj24802 = {};
return obj24802;
})();
 ...
 * Implementation detail. Subject to change.
 */
clojure.data.Diff = (function (){var obj24804 = {};
return obj24804;
})();
...
if((function (){var G__24805 = x;
if(G__24805){
var bit__18461__auto__ = (G__24805.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__18461__auto__) || (G__24805.cljs$core$IMap$)){
return true;
} else {
if((!G__24805.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__24805);
} else {
return false;
}
}
...
if(G__24806){
var bit__18461__auto__ = (G__24806.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__18461__auto__) || (G__24806.cljs$core$ISet$)){
return true;
} else {
if((!G__24806.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__24806);
} else {
return false;
}
}
...
if(G__24807){
var bit__18461__auto__ = (G__24807.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__18461__auto__) || (G__24807.cljs$core$ISequential$)){
return true;
} else {
if((!G__24807.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__24807);
} else {
return false;
}
}
...
return (function (){var G__24808 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__24808) {
case "map":
return clojure.data.diff_associative;
...
//# sourceMappingURL=data.js.map?rel=1435073925047