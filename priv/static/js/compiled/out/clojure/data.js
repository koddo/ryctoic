...
return cljs.core.reduce.call(null,(function (result,p__12073){
...
var vec__12076 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__12076,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__12076,(1),null);
var ab = cljs.core.nth.call(null,vec__12076,(2),null);
 ...
 */
clojure.data.EqualityPartition = (function (){var obj12078 = {};
return obj12078;
})();
...
if((function (){var and__4137__auto__ = x;
...
var x__4785__auto__ = (((x == null))?null:x);
return (function (){var or__4149__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4785__auto__)]);
if(or__4149__auto__){
return or__4149__auto__;
} else {
var or__4149__auto____$1 = (clojure.data.equality_partition["_"]);
 ...
 * Implementation detail. Subject to change.
 */
clojure.data.Diff = (function (){var obj12080 = {};
return obj12080;
})();
...
if((function (){var and__4137__auto__ = a;
if(and__4137__auto__){
...
var x__4785__auto__ = (((a == null))?null:a);
return (function (){var or__4149__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4785__auto__)]);
if(or__4149__auto__){
return or__4149__auto__;
} else {
var or__4149__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__4149__auto____$1){
return or__4149__auto____$1;
} else {
...
if((function (){var G__12081 = x;
if(G__12081){
var bit__4823__auto__ = (G__12081.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__4823__auto__) || (G__12081.cljs$core$IMap$)){
return true;
} else {
if((!G__12081.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__12081);
} else {
return false;
}
}
...
if((function (){var G__12082 = x;
if(G__12082){
var bit__4823__auto__ = (G__12082.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__4823__auto__) || (G__12082.cljs$core$ISet$)){
return true;
} else {
if((!G__12082.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__12082);
} else {
return false;
}
}
...
if((function (){var G__12083 = x;
if(G__12083){
var bit__4823__auto__ = (G__12083.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__4823__auto__) || (G__12083.cljs$core$ISequential$)){
return true;
} else {
if((!G__12083.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__12083);
} else {
return false;
}
}
...
return (function (){var G__12084 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__12084) {
case "map":
return clojure.data.diff_associative;
...
//# sourceMappingURL=data.js.map?rel=1434562321762